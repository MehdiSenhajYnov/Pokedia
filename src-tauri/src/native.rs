...
/// Shared application data directory used by the existing Tauri build.
///
/// Keeping the same path lets the native GTK client reuse the already-synced
/// database instead of forcing a second cache or migration path.
